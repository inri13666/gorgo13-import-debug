...
class ImportCommand extends Command
{
     ...
     * {@inheritdoc}
     */
    public function __construct(ImportHandler $importHandler, FileManager $fileManager)
    {
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $table->addRows([
            ...
            ['time given', sprintf('%.2f seconds', microtime(true) - $time)],
        ]);
        $table->render();
